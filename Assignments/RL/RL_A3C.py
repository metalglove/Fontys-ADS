...
wandb.init(name='A3C', project="deep-rl-2048")
...
def main():
    agent = Agent()
    agent.train(max_episodes=100_000)
    agent.global_actor.model.save_weights('global_actor_weights.h5')
    agent.global_critic.model.save_weights('global_actor_critic.h5')
